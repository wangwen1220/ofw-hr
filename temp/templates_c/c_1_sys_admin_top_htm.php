<?php /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2013-03-25 08:57 中国标准时间 */ ?>
...
：<strong style="color: #99FF00"><?php echo $this->_vars['admin_name']; ?>
        ...
        <tr>
		  ...
		  <a href="company.php?act=list" target="mainFrame" id="company">企业</a>
		  <a href="personal.php?act=list" target="mainFrame" id="personal">个人</a>
		  <a href="admin_article.php" target="mainFrame" id="article">内容</a>
		  <a href="admin_feedback.php?act=suggest_list" target="mainFrame" id="feedback">反馈</a>
