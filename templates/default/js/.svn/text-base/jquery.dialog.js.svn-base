...
if(dialogFirst==true){
  ...
  temp_float+="<iframe src=\"javascript:false\" style=\"position:absolute;z-index:2;display:block;visibility:inherit; top:0px; left:0px; width:510px; height:"+height+"; z-index:-1; filter='progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0)'; border:none;\"></iframe>";
