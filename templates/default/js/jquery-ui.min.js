...
b=Math.max(document.documentElement.offsetHeight,document.body.offsetHeight);if (c.browser.version == 8){return (document.body.scrollHeight > $(window).height() ? document.body.scrollHeight : $(window).height()) + "px";}return a<b?c(window).height()+"px":a+"px"}else return c(document).height()+"px"},width:function(){var a,b;if(c.browser.msie){a=Math.max(document.documentElement.scrollWidth,document.body.scrollWidth);b=Math.max(document.documentElement.offsetWidth,document.body.offsetWidth);if(c.browser.version==8){return (document.body.clientWidth>$(window).width()?document.body.clientWidth:$(window).width())+"px";}return a<b?c(window).width()+"px":a+"px"}else return c(document).width()+"px"},resize:function(){var a=c([]);c.each(c.ui.dialog.overlay.instances,
